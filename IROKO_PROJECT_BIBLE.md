...
2. Say: *"Read this fully. This is the Iroko project bible. I want to continue working on this."*
...
**Key entities extracted:** Mama Adebayo (Person), Oja Oba Market (Place), Lagos (Place), Ibadan (Place), Abeokuta (Place), Aso Oke cloth (Object), *Owó kì í mọ ojú ẹni tí ó ní* (Lesson — the proverb, the demo's emotional punchline)
...
**Designed cross-reference:** "rich textile trader" in Lagos, 1965 ↔ Mama Adebayo, textile trader at Oja Oba, 1960s. Two stories that the *human* eye can connect even without a graph.
...
*End of project bible. Update this file whenever a significant decision is made.*
